...
import LunchMenu1 from '../../assets/img/lunch-menus/lunch-menu-1.png'
    ...
    <>
      ...
      <section className="breakfast-card">
        <div className="breakfast-photo-name-button">
          <img src={LunchMenu1} className='breakfast-menu-photo' alt="" />
          <div className="breakfast-name-and-button">
            <h4 className='breakfast-name'>Mango Salsa Eşliğinde Izgara Karidesli Tacos</h4>
